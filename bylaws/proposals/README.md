...
1. `PROPOSED_GOVERNANCE.md` — the proposed structural model and rationale.
2. `TUESDAY_DECISION_SHEET.md` — the specific decisions leadership is being asked to approve, modify, or reject.
3. `PROPOSED_LOCAL_6350_AMENDMENTS.md` — draft amendment language for the parent Local 6350 Constitution.
4. `PROPOSED_GSU_CHAPTER_BYLAWS.md` — detailed internal GSU governance rules.
5. `TUESDAY_MEETING_BRIEF.md` — concise presentation flow for the meeting.
